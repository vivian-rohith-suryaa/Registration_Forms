	...
	<div class="form_div">
		<form class="form_container" action="FormServlet" method="post">
			...
			<div class="name_group">
				<label class="name-label" for="fname">First Name:<span style="color: red; font-weight: bold; margin-left: 5px;">*</span></label>
				...
				<label class="name-label" for="lname">Last Name:<span style="color: red; font-weight: bold; margin-left: 5px;">*</span></label>
	        ...
	        <div class="address">
	           	<label class="ad-label" for="district">District:<span style="color: red; font-weight: bold; margin-left: 5px;">*</span></label>
	           	...
	           	<label class="ad-label" for="state">State:<span style="color: red; font-weight: bold; margin-left: 5px;">*</span></label>
	           	<input class = "ad-input" type="text" id="state" name="state" value="<%= user.getState() != null ? user.getState() : "" %>" placeholder="State" required>    	
	        </div>
	            
	        <div class="address">
	           	<label class="ad-label" for="country">Country:<span style="color: red; font-weight: bold; margin-left: 5px;">*</span></label>
	           	...
	           	<label class="ad-label" for="pincode">Pin-Code:<span style="color: red; font-weight: bold; margin-left: 5px;">*</span></label>
	         	<input class = "ad-input" type="text" id="pincode" name="pincode" value="<%= user.getPincode() != null ? user.getPincode() : "" %>" placeholder="Pincode" pattern="[0-9]{6}" title="Pin-Code should be exactly 6 digits "required>	
	        </div>

			<label class="generic_label" for="setpasswod">Password:<span style="color: red; font-weight: bold; margin-left: 5px;">*</span></label> 
			<input class="form_input" type="password" id="setpassword" name="setpassword" value="<%= user.getPassword() != null ? user.getPassword() : "" %>" placeholder="New_Password" required minlength="8" pattern="(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*?&#])[A-Za-z\d@!#$%*&?]{8,20}" title="Password must be between 8 and 20 characters long and include a letter, a number, and a special character."> 
